...
void desenha_inimigos(ALLEGRO_BITMAP* monstro_png[], ALLEGRO_BITMAP* jack_png, struct Personagem inimigos[], struct Personagem* jack, int level)
{
	if (level == 1)
	{
		...
		al_draw_scaled_bitmap(monstro_png[0],
			...
			inimigos[0].largura_sprite_tela, inimigos[0].altura_sprite_tela, 0);
		...
		al_draw_scaled_bitmap(monstro_png[2],
			...
			inimigos[2].largura_sprite_tela, inimigos[2].altura_sprite_tela, ALLEGRO_FLIP_HORIZONTAL);
		...
		al_draw_scaled_bitmap(monstro_png[2],
			...
			inimigos[2].largura_sprite_tela, inimigos[2].altura_sprite_tela, 0);
	}
	else if (level == 2)
	{
